        ...
        BottomSheetView(
            ...
            VStack(alignment: .leading, spacing: .s3) {
                VStack(alignment: .leading, spacing: 12) {
                    DText("정말 무소비 했나요?", style: .h2, weight: .bold, color: ColorPalette.Neutral.gray99)
                    DText("무소비는 하루 동안 한 번도 소비하지 않았을 때 선택해요.\n지금까지 기록한 내용이 있다면 모두 사라져요!", style: .b2, weight: .regular, color: ColorPalette.Primary.deepBlue90)
                        .lineSpacing(6)
                }
                HStack(spacing: 10) {
                    Button {
                        ...
                        ZStack {
                            ...
                            .fill(ColorPalette.Primary.deepBlue50)
                            .frame(height: 58)
                            DText("안했어요", style: .h3, weight: .bold, color: .white)
                        }
                    }
                    ...
                    Button {
                        ...
                        ZStack {
                            ...
                            .fill(ColorPalette.Neutral.gray95)
                            .frame(height: 58)
                            DText("했어요", style: .h3, weight: .bold, color: ColorPalette.Primary.deepBlue20)
                        }
                    }
                }
                .padding(.vertical, 10)

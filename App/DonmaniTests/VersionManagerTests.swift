...
struct VersionManagerTests {
    ...
    @Test func compare_equal_version() async throws {
    ...
    @Test func compare_lower_major_version() async throws {
    ...
    @Test func compare_lower_minor_version() async throws {
        let currentVersion = "1.17.0"
        let storeVersion = "1.16.0"
        #expect(versionManager.isLastestVersion(store: storeVersion, current: currentVersion) == true)
    }
    
    @Test func compare_lower_build_version() async throws {
